...
// Determine the computed theme, which can be "dark" or "light". Use dark mode for the
// default "system" setting while preserving explicit light and dark selections.
